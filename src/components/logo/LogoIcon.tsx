...
const LogoIcon = () => {
  ...
  return (
    <svg fill="#000000" width="129px" height="129px" viewBox="0 0 32.00 32.00" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" stroke-width="0">
        <rect x="0" y="0" width="32.00" height="32.00" rx="16" fill={theme.palette.background.paper} stroke-width="0"></rect>
      </g>
